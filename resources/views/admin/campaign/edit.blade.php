...
<div class="p-4">
    ...
    <section class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body p-4">
                            <form autocomplete="off" class="form-horizontal" id="module_form" action="{{route('admin.campaigns.update',$campaign->id)}}" name="module_form" novalidate="novalidate">
                                @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="form-group d-flex align-items:center">
                                                <select class="form-control form-control-sm" name="status" id="status">
                                                    <option {{$campaign->status == 1 ? 'selected' : ''}} value="1" selected>Active</option>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Please enter name" id="name" name="name" value="{{$campaign->name??''}}">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="campaign_category_id" id="campaign_category_id">
                                                        ...
                                                        <option @if($campaign->campaign_category_id == $campaignCategory->id) 'selected' @else '' @endif value="{{$campaignCategory->id}}">{{$campaignCategory->name}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$campaign->start_datetime??''}}" type="text" id="start_datetime" name="start_datetime" class="form-control">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$campaign->end_datetime??''}}" type="text" id="end_datetime" name="end_datetime" class="form-control">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$campaign->donation_target??''}}" type="number" class="form-control" placeholder="Please enter donation target" id="donation_target" name="donation_target" value="{{old('donation_target')}}">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$campaign->unique_code??''}}" type="text" class="form-control" placeholder="Please enter unique code" id="unique_code" name="unique_code" value="{{old('unique_code')}}">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-md-5 col-lg-4">
                                                        <div id="preview_div" style="">
                                                            <img id="image_preview" style="width: auto;" height="70" class="profile-user-img" src="{{$campaign->image}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 p-3" id="file_uplaod_section">
                                                ...
                                                <label id="files_uplaod_error_list" class="error"></label>
                                            </div>
                                            <!-- Uplaod Images end -->
        ...
        <input id="campaign_category_id_val" type="hidden" value="{{$campaign->campaign_category_id}}">
    </section>
</div>
@php
    ...
    $(document).ready(function() {
        ...
        $("#file_uplaod_section #add_more_files").click(function() {
            ...
            if (validateImageFields()) {
                ...
                // var row = `<tr>
                //                 <td><img src="${URL.createObjectURL(image)}" alt="Preview" style="width: 30px; height: 30px;"></td>
                //                 <td>${image.name}</td>
                //                 <td>${title}</td>
                ...
                prepareFileRow(imglink, image.name, title, description);
        ...
        function prepareFileRow(image, image_name, title, description = '') {
            var row = `<tr>
        ...
        function prepareVideoRow(urlInput, v_title, v_description = '') {
            var v_row = `<tr>
                <td>${urlInput}</td>
                <td>${v_title}</td>
                <td>${
        ...
        for (const item of fileList) {
            console.log('fileList', fileList);
            prepareFileRow(item.image, item.image.split('/').pop(), item.title, item.description);
        }

        // Loop through the imageArray and create rows for each item
        for (const item of videoList) {
            console.log('fileList', videoList);
            prepareVideoRow(item.link, item.title, item.description);
        }
        ...
        $("#module_form").validate({
            ...
            submitHandler: function(form, e) {
                ...
                fileList.forEach(function(fileObject, index) {
                    formData.append('files_uplaod[' + index + '][id]', fileObject.id ?? null);
                    formData.append('files_uplaod[' + index + '][image]', fileObject.image);
                ...
                videoList.forEach(function(videoObject, v_index) {
                    formData.append('video[' + v_index + '][id]', videoObject.id ?? null);
                    formData.append('video[' + v_index + '][link]', videoObject.link);
                ...
                console.log('videoList =====>', videoList, 'fileList========>', fileList);
                $.ajax({
                    url: form.action,
                    type: "POST",
                    data: formData,
                    ...
                    error: function(result) {
                        ...
                        $.each(errors, function(field, messages) {
                            ...
                            if (field == 'files_uplaod' || field == 'video') {
                                $(field+'_error_list').closest(".form-group")
                                    .find(".error")
                                    .text(messages[0]);
                            } else {
                                inputField

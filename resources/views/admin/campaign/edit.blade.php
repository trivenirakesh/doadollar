...
<div class="p-4">
    ...
    <section class="content">
                        ...
                        <div class="card-body p-4">
                            <form autocomplete="off" class="form-horizontal" id="module_form" action="{{route('admin.campaigns.update',$campaign->id)}}" name="module_form" novalidate="novalidate">
                                ...
                                <div class="modal-footer justify-content-center">
                                    <button type="submit" class="btn btn-primary" id="module_form_btn">Update<span style="display: none" id="module_form_loader"><i class="fa fa-spinner fa-spin"></i></span></button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <input id="campaign_startdatetime_val" type="hidden" value="{{$campaign->start_datetime}}">
        <input id="campaign_enddatetime_val" type="hidden" value="{{$campaign->end_datetime}}">
...
<script src="{{asset('public/asset/js/campaign/edit.js')}}"></script>
@endpush
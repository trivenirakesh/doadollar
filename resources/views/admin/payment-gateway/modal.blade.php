...
<div class="modal fade" id="modal-add-update" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="module_form" action="{{route('admin.payment-gateway.store')}}" name="module_form" novalidate="novalidate">
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ __('messages.validation.name') }}" id="name" name="name" value="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Api Key <span class="red">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ __('messages.validation.api_key') }}" id="api_key" name="api_key" value="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Secret Key <span class="red">*</span></label>
                                    <input type="text" class="form-control" placeholder="{{ __('messages.validation.secret_key') }}" id="secret_key" name="secret_key" value="">
                                </div>
                            </div>
                            <div class="col-sm-7">
                                <div class="form-group">
